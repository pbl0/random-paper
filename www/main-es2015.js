...
const routes = [
    ...
    {
        path: 'donate',
        loadChildren: () => __webpack_require__.e(/*! import() | donate-donate-module */ "donate-donate-module").then(__webpack_require__.bind(null, /*! ./donate/donate.module */ "./src/app/donate/donate.module.ts")).then(m => m.DonatePageModule)
    },
    {
        path: 'reddit-settings',
        loadChildren: () => Promise.all(/*! import() | reddit-settings-reddit-settings-module */[__webpack_require__.e("common"), __webpack_require__.e("reddit-settings-reddit-settings-module")]).then(__webpack_require__.bind(null, /*! ./reddit-settings/reddit-settings.module */ "./src/app/reddit-settings/reddit-settings.module.ts")).then(m => m.RedditSettingsPageModule)
    },
    {
        path: 'unsplash-settings',
        loadChildren: () => Promise.all(/*! import() | unsplash-settings-unsplash-settings-module */[__webpack_require__.e("common"), __webpack_require__.e("unsplash-settings-unsplash-settings-module")]).then(__webpack_require__.bind(null, /*! ./unsplash-settings/unsplash-settings.module */ "./src/app/unsplash-settings/unsplash-settings.module.ts")).then(m => m.UnsplashSettingsPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /home/pablo/Dev/Android/ionic/random-paper/src/main.ts */"./src/main.ts");
